...
<link rel="stylesheet" href="le_chuan.css">
...
<script type="text/javascript" src="le_chuan.js?v=1001"></script>
...
<span type="label_content">未开通</span>
</label>
<label class="frm_radio_label" style="padding:0px;" bindtap="search_service">
<i class="icon_radio"></i>
<span type="label_content">已开通</span>
</label>
<label class="frm_radio_label" style="padding:0px;" bindtap="search_service">
<i class="icon_radio"></i>
<span type="label_content">申请中</span>
</label>
<label class="frm_radio_label" style="padding:0px;" bindtap="search_service">
<i class="icon_radio"></i>
...
<th width="6%">服务</th>
<th width="6%">开通时间</th>
<th width="6%"><a order="num_update" class="order_search" href="javascript:void(0);">文章发布<i></i></a></th>
<th width="6%"><a order="num_update" class="order_search" href="javascript:void(0);">红包投放总额<i></i></a></th>
<th width="6%"><a order="num_update" class="order_search" href="javascript:void(0);">分销员(人)<i></i></a></th>
<th width="6%"><a order="num" class="order_search" href="javascript:void(0);">成交笔数<i></i></a></th>
<th width="6%"><a order="num" class="order_search" href="javascript:void(0);">总成交额<i></i></a></th>
<th width="6%"><a order="num" class="order_search" href="javascript:void(0);">总佣金支出<i></i></a></th>
<th width="6%">业务组</th>
<th width="6%">业务员</th>
</tr>
</thead>
...
<!-- S shop_service -->
<div class="shop_service shop_nav_item" style="display:;">
<div class="items">
