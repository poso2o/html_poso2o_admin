...
<link rel="stylesheet" href="/le_chuan/selected/selected.css">
...
<script type="text/javascript" src="/le_chuan/selected/selected.js?v=1001"></script>
...
<div class="list"><label>类目</label><span class="combox CA_p dropDownBox" style="width:160px" bindtap="search_address"><input class="comboxText" type="text" style="width:126px" readonly value="请选择省份" comboxval=""><span class="comboxArrow"></span><div class="pannel hideDiv" style="width:160px;"><ul class="CA_p_lists"></ul></div></span>
...
<label>售价</label>
<div class="list positionList" style="width:60px;margin-left:0px;margin-bottom:0px;">
<input style="width:60px;" type="text" maxlength="30" value="" name="keywords" class="inputText keywords" placeholder="" bindinput="search_keywords">
</div>
<label style="padding:0 4px">-</label>
<div class="list positionList" style="width:60px;margin-left:0px;margin-bottom:0px;">
<input style="width:60px;" type="text" maxlength="30" value="" name="keywords" class="inputText keywords" placeholder="" bindinput="search_keywords">
</div>
</div>
