...
<html>
	...
	<body class="">
		<div class="layui-layout layui-layout-admin">
							...
							<div class="layui-form-item">
								...
								<div class="layui-inline">
									...
									<div class="layui-input-block" style="margin-left: 86px;">
										<input id="storeState_1" type="radio" name="shop_state" lay-filter="shop_state" value="1" title="待开通(0)" checked>
										<input id="storeState_6" type="radio" name="shop_state" lay-filter="shop_state" value="6" title="试用(0)">
								...
								<div class="layui-inline">
									<a href="javascript:void(0);" onclick="shopStatus.show_create_shop_dialog($(this));" class="layui-btn" type="0">开户</a>
								</div>
							</div>
						</div>
			...
			<div class="layui-footer entity_shop_footer">
				<div class="menu_cont">
					...
					<a class="menu examine_menu" href="javascript:void(0);"><i id="shop_news_icon">&nbsp;</i><em>0</em>位商家待审核</a>
				</div>
			</div>
		...
		<script type="text/javascript" src="/entity_shop/entity_shop.js?v=1001"></script>
